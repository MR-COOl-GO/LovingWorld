...
/**
 * Created by 甄大昌 on 2017/1/23.
 */

public class LWFriendFragment extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        testOrmlite();
        friendView = (RecyclerView)rootView.findViewById(R.id.recyclerview_fragment_friend);
